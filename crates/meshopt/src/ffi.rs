...
unsafe extern "C" {
    pub fn meshopt_encodeIndexBufferBound(
        index_count: usize,
        vertex_count: usize,
    ) -> usize;
}
...
unsafe extern "C" {
    pub fn meshopt_encodeIndexSequenceBound(
        index_count: usize,
        vertex_count: usize,
    ) -> usize;
}
...
unsafe extern "C" {
    pub fn meshopt_encodeVertexBufferBound(
        vertex_count: usize,
        vertex_size: usize,
    ) -> usize;
}
...
pub const meshopt_EncodeExpMode_meshopt_EncodeExpSeparate:
    meshopt_EncodeExpMode = 0;
pub const meshopt_EncodeExpMode_meshopt_EncodeExpSharedVector:
    meshopt_EncodeExpMode = 1;
pub const meshopt_EncodeExpMode_meshopt_EncodeExpSharedComponent:
    meshopt_EncodeExpMode = 2;
pub const meshopt_EncodeExpMode_meshopt_EncodeExpClamped:
    meshopt_EncodeExpMode = 3;
